...
<form action = 'includes/addstaffs.php' method='post'>
  <table style="width: 100%">
    <tr>
      ...
      <tr>
          ...
          <td><input name="staffpassword" type="text" required></td>
        </tr>
        <tr>
            <td style="width: 156px">StaffEmail:</td>
            <td><input name="staffemail" type="text" required></td>
          </tr>
  <tr>
  ...
  <input name="btnAddStaff" type="submit" value="Submit"><br>
  </form>;
</body>
