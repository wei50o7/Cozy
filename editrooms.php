...
<section class="py-5">
  ...
  $id = intval ($_GET['roomid']); //Get the id from URL
  $result = mysqli_query ($conn,"SELECT * FROM room WHERE RoomID=$id");
 ...
 <table style="width: 100%">
    ...
    <tr>
      <td style="width: 156px">RoomType:</td>
      <td><input name="roomtype" type="text" required value="<?php echo $row['RoomType'] ?>"></td>
    </tr>
    <tr>
      <td style="width: 156px">PricePerNight:</td>
      <td><input name="pricepernight" type="index" required value="<?php echo $row['PricePerNight'] ?>"></td>
    </tr>
