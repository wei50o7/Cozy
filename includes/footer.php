      ...
      <div class="col-md">
        <div class="ftco-footer-widget mb-4">
          ...
          <ul class="ftco-footer-social list-unstyled float-md-left float-lft">
            <li class="ftco-animate"><a href="https://twitter.com/SamarindaCozy"><span class="icon-twitter"></span></a></li>
            <li class="ftco-animate"><a href="https://www.facebook.com/Cozy-Hotel-At-kl-sentral-1320909711308073/ "><span class="icon-facebook"></span></a></li>
            <li class="ftco-animate"><a href="https://www.instagram.com/cozystylelinggau/"><span class="icon-instagram"></span></a></li>
          </ul>
        </div>
      </div>
      <div class="col-md">
      ...
      <div class="col-md">
         <div class="ftco-footer-widget mb-4">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="#" class="py-2 d-block">+60 16885-2024</a></li>
            <li><a href="#" class="py-2 d-block">cozyhotel@mail.com</a></li>
          </ul>
        </div>
      </div>
          </form>
