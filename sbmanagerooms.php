...
<head>
  ...
  <body>
   ...
   <table cellspacing="0">
      ...
      echo "</td>";
      echo "<td>";
      echo $row['PricePerNight'];
      echo "</td>";
      echo "<td><a href=\"editrooms.php?roomid=";
      echo $row['RoomID'];
      echo "\">Edit</a></td>";
      echo "<td><a href=\"deleterooms.php?roomid=";
      echo $row['RoomID'];
      echo "\" onClick=\"return confirm('Delete details for RoomID=";
      echo $row['RoomID'];
      echo "?');\">Delete</a></td></tr>";
      }
      echo "<tr bgcolor=\"#FFF200\">";
      echo "<td><a href=\"addrooms.php";
      echo "\">AddRoom</a></td></tr>";
